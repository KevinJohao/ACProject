...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    // Rutas del admin
    Route::get('/projects', [App\Http\Controllers\ProductController::class, 'index']); //listado
    Route::get('/projects/create', [App\Http\Controllers\ProductController::class, 'create']); //formulario
    Route::post('/projects', [App\Http\Controllers\ProductController::class, 'store']); //registrar
    Route::get('/projects/{id}/edit', [App\Http\Controllers\ProductController::class, 'edit']); //form de edicion
    Route::post('/projects/{id}/edit', [App\Http\Controllers\ProductController::class, 'update']); //actualizar
    Route::delete('/projects/{id}', [App\Http\Controllers\ProductController::class, 'destroy']); //form eliminar
});
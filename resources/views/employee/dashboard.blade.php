            ...
            <table class="table align-items-center justify-content-center mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nombre del proyecto</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Cliente</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Lugar</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 col-xs-2 text-center">Fecha inicio</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 col-xs-2 text-center">Fecha entrega</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 col-xs-1 text-right">Precio</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 col-xs-1 text-center">Estado</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 text-center">Opciones</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td class="text-center text-xs">{{ $project->id }}</td>
                        <td class="text-left text-xs">{{ $project->name }}</td>
                        <td class="text-left text-xs">
                            {{ $project->client->user->name }}
                        </td>
                        <td class="text-left text-xs">{{ $project->place }}</td>
                        <td class="col-xs-2 text-center text-xs">{{ $project->start_date }}</td>
                        <td class="col-xs-2 text-center text-xs">{{ $project->due_date }}</td>
                        <td class="col-xs-1 text-right text-xs">&dollar; {{ $project->total_value }}</td>
                        <td class="col-xs-1 text-center text-xs">{{ $project->TaskStatus->name }}</td>
                        <td class="text-center td-actions text-md">
                            <form method="post" action="{{ url('/admin/projects/' . $project->id) }}">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
                                <a href="{{ url('/empleado/projects/' . $project->id . '/show') }}" title="Ver proyecto" class="text-info">
                                    <i class="fa fa-eye"></i>
                                </a>
                            </form>
                        </td>
